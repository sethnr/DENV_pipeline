...
def get_defaults(config):
    ...
    config["reference_directory"] = pkg_resources.resource_filename('refgenomes','refs/')
    config["workflow_directory"] = pkg_resources.resource_filename('snakemake', './snakemake/')
